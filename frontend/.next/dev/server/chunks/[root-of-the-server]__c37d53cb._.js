...
async function GET(req) {
    try {
        const sessionUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUser"])(req);
...
async function PATCH(req) {
    try {
        ...
        const mergedProfile = {
            ...
            ...incomingProfile.postal_code && !incomingProfile.postalCode ? {
                postalCode: incomingProfile.postal_code
            } : {},
            ...incomingProfile
        };
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/auth.ts [app-route] (ecmascript)"); // <-- adjust path if your NextAuth options are located elsewhere
;
;
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c37d53cb._.js.map