...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)"); // adjust path to your prisma client
;
;
;
;
...
function createSessionJwt(payload) {
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jose$2f$dist$2f$webapi$2f$jwt$2f$sign$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SignJWT"]({
        ...
        alg: "HS256"
    }).setExpirationTime(exp).sign(secret);
}
async function POST(request) {
    try {
        ...
        // create a session token (JWT) — replace with your session handling
...
//# sourceMappingURL=%5Broot-of-the-server%5D__69d5d631._.js.map