...
function SignupPage() {
    ...
    async function handleSendPhoneOtp(e) {
        ...
        try {
            ...
            if (data?.ok) setMode("verifyPhone");
            else setError(data?.error || "Failed to send phone OTP");
        } catch (err) {
            setError(String(err));
        } finally{
            setLoading(false);
    ...
    async function handleFinalize(e) {
        ...
        setLoading(true);
        try {
            const res = await postJSON(`/api/auth/signup/finalize`, {
                tempToken,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4542fbd1._.js.map