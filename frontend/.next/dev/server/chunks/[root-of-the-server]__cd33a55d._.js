...
function signTemp(payload, expiresIn = "15m") {
    ...
    delete safePayload.exp; // prevent conflict with `exp` inside payload
...
"[project]/src/app/api/auth/oauth/google/start/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const state = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$jwt$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["signTemp"])({
        redirect,
        inviteId,
        flow
    }, "10m");
    const params = new URLSearchParams({
        ...
        redirect_uri: `${("TURBOPACK compile-time value", "http://localhost:3000")}/api/auth/oauth/google/callback`,
        response_type: "code",
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(googleUrl);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__cd33a55d._.js.map