...
if (twilioSid && twilioAuth) {
    client = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$twilio$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(twilioSid, twilioAuth);
}
...
"[project]/src/app/api/auth/phone/send/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        // Create OTP (store or cache code)
        const { id, code } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$otp$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createPhoneOtp"])(phone);
        // Send SMS with the OTP
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sms$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendSms"])(phone, `Your verification code is ${code}. It expires in 10 minutes.`);
        // If Twilio responded with an error
        if (result?.error) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: result.error,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__970dfa50._.js.map