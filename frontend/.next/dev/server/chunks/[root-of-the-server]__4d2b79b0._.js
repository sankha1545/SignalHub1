...
----------------------------------------------------------- */ async function markChatRead(chatId, userId) {
    try {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].chatLastRead) return;
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].chatLastRead.upsert({
            where: {
                chatId_userId: {
                    chatId,
                    userId
...
async function GET(req, ctx) {
    try {
        ...
        if (before) {
            ...
            if (!isNaN(date.getTime())) where.createdAt = {
                lt: date
            };
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d2b79b0._.js.map