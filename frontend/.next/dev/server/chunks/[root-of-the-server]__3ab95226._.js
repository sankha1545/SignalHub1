...
async function GET(req) {
    try {
        ...
        try {
            if (!organizationId && typeof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUser"] === "function") {
                const s = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSessionUser"])(req).catch(()=>null);
                if (s?.organizationId) organizationId = s.organizationId;
            }
        } catch (e) {
            console.warn("[api/users] getSessionUser error", e?.message || e);
        }
        if (!organizationId) {
        ...
        const normalized = users.map((u)=>({
                ...
                name: u.name,
                email: u.email,
                initials: (u.name || "").split(/\s+/).map((p)=>p[0]).slice(0, 2).join("").toUpperCase()
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: true,
            users: normalized
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3ab95226._.js.map