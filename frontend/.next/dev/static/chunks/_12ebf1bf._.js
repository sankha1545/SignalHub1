...
function AccountPage() {
    ...
    // State variables for user info, form, and loading states
    ...
    const [form, setForm] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        ...
        language: "",
        district: "",
        password: "" // Added for password functionality
    });
    ...
    const [photoModal, setPhotoModal] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    // Helper to safely read profile fields
            ...
            async function loadMeta() {
                ...
                try {
                    ...
                    setLanguages(Array.from(langSet).sort({
                        "AccountPage.useEffect.loadMeta": (a_0, b_0)=>a_0.localeCompare(b_0)
                    }["AccountPage.useEffect.loadMeta"]));
                } catch (err) {
            ...
            async function loadUser() {
                ...
                try {
                    ...
                    if (json?.ok && json.user) {
                        const u = json.user;
                        const profile_0 = u.profile ?? {};
                        const mapped = {
                            name: u.name ?? "",
                            phone: u.phone ?? "",
                            displayName: readProfileField(profile_0, "displayName", "display_name") ?? "",
                            avatarUrl: readProfileField(profile_0, "avatarUrl", "avatar_url") ?? "",
                            bio: readProfileField(profile_0, "bio") ?? "",
                            country: readProfileField(profile_0, "country") ?? "",
                            region: readProfileField(profile_0, "region", "state") ?? "",
                            postalCode: readProfileField(profile_0, "postalCode", "postal_code") ?? "",
                            language: readProfileField(profile_0, "language") ?? "",
                            district: readProfileField(profile_0, "district", "city") ?? ""
                        };
                        setUser(u);
                        setForm(mapped);
                    ...
                    console.error("Failed to load user", err_0);
                    router.push("/login");
                } finally{
                    setLoading(false);
                }
    ...
    async function uploadPhoto(file_0) {
        if (!file_0) return form.avatarUrl || null;
        try {
            const fd = new FormData();
            fd.append("file", file_0);
            const res_1 = await fetch("/api/upload", {
                method: "POST",
                body: fd
            });
            const json_0 = await res_1.json();
            if (json_0?.ok && json_0.url) return json_0.url;
            throw new Error(json_0?.error || "Upload failed");
        } catch (err_1) {
            console.warn("uploadPhoto failed", err_1);
            throw err_1;
        }
    }
    ...
    async function handleSave(e) {
        ...
        try {
            ...
            if (json_1.ok) {
                setUser(json_1.user);
                setEditing(false);
                setPhotoPreview(json_1.user.profile?.avatarUrl ?? avatarUrl ?? null);
                setForm((prev)=>({
                        ...prev,
                        avatarUrl: avatarUrl
                    }));
            } else {
                alert(json_1.error || "Failed to update profile.");
            }
        } catch (err_2) {
...
_s(AccountPage, "PLQXHWcFhq7ULH0Lk6f89GP97Tk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
_c = AccountPage;
// Floating input component with label
function FloatingInput(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(15);
    if ($[0] !== "ba0d85725c18a3b8301f08475414be3a9ce088a83349ed14c3a389bbde014c38") {
        for(let $i = 0; $i < 15; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ba0d85725c18a3b8301f08475414be3a9ce088a83349ed14c3a389bbde014c38";
    }
...
//# sourceMappingURL=_12ebf1bf._.js.map