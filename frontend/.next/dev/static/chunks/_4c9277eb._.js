...
/* -------------------------
   ...
   ------------------------- */ const IconButton = (t0)=>{
    ...
    if ($[0] !== "215a0e1360be7c5f4d1c5bd573128ef1b6c4df83fcc77aa637b613bcb8527f58") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "215a0e1360be7c5f4d1c5bd573128ef1b6c4df83fcc77aa637b613bcb8527f58";
    }
...
/* -------------------------
   ...
   ------------------------- */ const ChatRow = (t0)=>{
    ...
    const t12 = chat.lastMessagePreview ?? (chat.type?.toLowerCase() === "team" ? "Team chat \u2014 no messages yet" : "No messages yet");
    let t13;
    if ($[13] !== t12) {
...
function EmployeeInboxPage() {
                            ...
                            setChats({
                                "EmployeeInboxPage.useEffect.onMessage": (prev_0)=>prev_0.map({
                                        "EmployeeInboxPage.useEffect.onMessage": (c_1)=>{
                                            ...
                                            const content = payload_1?.message?.content;
                                            return {
                                                ...c_1,
                                                lastMessagePreview: content ? content.length > 120 ? content.slice(0, 120) + "…" : content : c_1.lastMessagePreview,
    ...
    function handleSelectChat(chat_0) {
        const t_0 = chat_0.type?.toLowerCase();
        if (t_0 === "direct" && !chat_0.meta?.isWithManager) {
...
//# sourceMappingURL=_4c9277eb._.js.map