...
function SignupPage() {
    ...
    function startGoogleOAuthSignup() {
        window.location.href = "/api/auth/oauth/google/start?flow=signup";
    }
    async function handleSendEmailOtp(e) {
        ...
        try {
            ...
            if (data?.ok) setMode("verifyEmail");
    ...
    async function handleVerifyEmailOtp(e_0) {
        e_0?.preventDefault();
        setError(null);
        setLoading(true);
        try {
            ...
            if (data_0?.ok && data_0?.tempToken) {
                ...
                setMode("phone");
            } else setError(data_0?.error || "Invalid code");
        } catch (err_0) {
            setError(String(err_0));
        } finally{
            setLoading(false);
        }
    }
    async function handleSendPhoneOtp(e_1) {
        e_1?.preventDefault();
        setError(null);
        setLoading(true);
        try {
            ...
            if (data_1?.ok) setMode("verifyPhone");
            else setError(data_1?.error || "Failed to send phone OTP");
        } catch (err_1) {
    ...
    async function handleVerifyPhoneOtp(e_2) {
        e_2?.preventDefault();
        setError(null);
        setLoading(true);
        try {
    ...
    async function handleFinalize(e_3) {
        e_3?.preventDefault();
        setError(null);
        setLoading(true);
        try {
            const res_0 = await postJSON(`/api/auth/signup/finalize`, {
                tempToken,
            ...
            } else setError(res_0?.error || "Failed to finalize");
        } catch (err_3) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                ...
                children: "Create organization — Admin signup"
            }, void 0, false, {
            ...
            mode === "choose" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onClick: startGoogleOAuthSignup,
                        className: "w-full p-3 border rounded-lg flex items-center justify-center gap-3",
                        children: [
            ...
            mode === "verifyEmail" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        value: emailCode,
                        onChange: (e_5)=>setEmailCode(e_5.target.value),
                        className: "w-full p-2 border rounded"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(auth)/signup/page.tsx",
                        lineNumber: 154,
            ...
            mode === "phone" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                        className: "block text-sm",
                        children: "Phone (with country code)"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(auth)/signup/page.tsx",
                        lineNumber: 162,
                        columnNumber: 11
            ...
            mode === "verifyPhone" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        value: phoneCode,
                        onChange: (e_7)=>setPhoneCode(e_7.target.value),
                        className: "w-full p-2 border rounded"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(auth)/signup/page.tsx",
                        lineNumber: 173,
            ...
            mode === "org" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                        className: "block text-sm",
                        children: "Password (optional — set if you want email/password login)"
                    }, void 0, false, {
                        fileName: "[project]/src/app/(auth)/signup/page.tsx",
                        lineNumber: 187,
                        columnNumber: 11
...
_s(SignupPage, "kDNLVMGBrkqXFVsTJh1x670MVJs=");
_c = SignupPage;
var _c;
...
//# sourceMappingURL=_8881e2da._.js.map